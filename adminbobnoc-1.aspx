<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adminbobnoc-1.aspx.cs" Inherits="adminbobnoc_1" %>
...
<body>
    <form id="form1" runat="server">
     <nav>
        ...
        <div class="menu">
            <ul>
               <%-- <li><a href="bobnoc.aspx"><i class="fa fa-undo"></i> Back</a></li>--%>
     ...
     <div class="box">
        <div class="box1">
            <div class="box2">
                ...
                <div class="d">
                     This is to confirm that we have sold Unit no.<asp:Label ID="txtblockno" CssClass="lbltext" runat="server" Text=""></asp:Label>-<asp:Label ID="txtflatno" CssClass="lbltext" runat="server" Text=""></asp:Label>on <asp:Label ID="txtfloor" CssClass="lbltext" runat="server" Text=""></asp:Label>floor in the building
