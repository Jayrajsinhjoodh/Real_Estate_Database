...
public partial class receipt : System.Web.UI.Page
{
    ...
    protected void submit_Click0(object sender, EventArgs e)
    {
        ...
        Response.Redirect("receipt-1.aspx");
    ...
    protected void submit_Click2(object sender, EventArgs e)
    {
        ...
        Response.Write("<script>window.print(); onafterprint=function(){ window.location.href='receipt.aspx?Edit=" + Request.QueryString["edit"] + "';}  </script>");
