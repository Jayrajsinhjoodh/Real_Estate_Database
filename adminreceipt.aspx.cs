...
public partial class adminreceipt : System.Web.UI.Page
{
    SqlConnection con;
    SqlCommand cmd;
    SqlDataAdapter da;
    ...
    protected void submit_Click0(object sender, EventArgs e)
    {
        ...
        Response.Redirect("adminreceipt-1.aspx");
    ...
    protected void submit_Click2(object sender, EventArgs e)
    {
        ...
        Response.Write("<script>window.print(); onafterprint=function(){ window.location.href='adminreceipt.aspx?Edit=" + Request.QueryString["edit"] + "';}  </script>");
