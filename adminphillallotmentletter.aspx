<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adminphillallotmentletter.aspx.cs" Inherits="adminphillallotmentletter" %>
...
<body>
    ...
    <div class="box"><div class="card-title1">ALLOTMENT LETTER</div>
        <div class="box1">
            ...
            <div class="card-title3">Non-Agricultural land bearing Town Planning Scheme No. 1 , final plot No.87 of survey No. 172, Mouje: KHOKHRA , Taluka: Maninagar in the Registration District of Ahmedabad and Sub -District of Ahmedabad-5 (Narol) holding by “SUN INFRA” a Partnership Firm. The said partnership firm has put up a scheme of residential units knows as“PUSHKAR HILL “On the said land.
            </div>
