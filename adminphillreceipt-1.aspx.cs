...
public partial class adminphillreceipt_1 : System.Web.UI.Page
{
    SqlConnection con;
    SqlCommand cmd;
    SqlDataAdapter da;
    ...
    protected void submit_Click(object sender, EventArgs e)
    {
        ...
        cmd.ExecuteNonQuery();
        Response.Write("<script>alert('Registration Successfully'); window.location.href='adminphillreceipt.aspx?edit=" + Session["edit"] + "';</script>");
        con.Close();
        con.Close();
    }
