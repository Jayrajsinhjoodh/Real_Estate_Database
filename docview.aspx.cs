...
public partial class _Default : System.Web.UI.Page
{
    ...
    {
        Response.Write("<script> window.location.href='allotmentletter.aspx';</script>");

    }
    protected void submit2_Click(object sender, EventArgs e)
    {
        Response.Write("<script> window.location.href='demandletter.aspx';</script>");
    }
    protected void submit3_Click(object sender, EventArgs e)
    {
        Response.Write("<script> window.location.href='receipt.aspx';</script>");
    }
    ...
    protected void DropDownList1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("bobnoc.aspx");
        }
        else if (DropDownList1.SelectedIndex == 2)
        {
            Response.Redirect("axisnoc.aspx");
        }
