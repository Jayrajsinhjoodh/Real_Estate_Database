...
public partial class adminblockc : System.Web.UI.Page
{
    SqlConnection con;
    SqlCommand cmd;
    SqlDataAdapter da;
    ...
    {
        mycon();
        cmd = new SqlCommand("select * from customer_registration where sidename='PUSHKAR LUXURIA' and blockno='C'", con);
