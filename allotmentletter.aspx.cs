...
public partial class allotmentletter : System.Web.UI.Page
{
    ...
    protected void submit_Click1(object sender, EventArgs e)
    {
        ...
        Response.Write("<script> window.location.href='allotmentletter1.aspx';</script>");
    }
    protected void submit_Click2(object sender, EventArgs e)
    {
        ...
        Response.Write("<script>window.print(); onafterprint=function(){ window.location.href='allotmentletter.aspx';}  </script>");
