<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adminforgottenpassword.aspx.cs" Inherits="adminforgottenpassword" %>
    ...
    <div class="main">
        <div class="card">
            <div class="card-title">
                <img src="logo12588888.jpg" style="width: 120px;" alt="" srcset="">find your admin account.
            </div>
            <div class="box">
