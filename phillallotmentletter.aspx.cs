...
public partial class allotmentletter : System.Web.UI.Page
{
    ...
    {
        Response.Write("<script> window.location.href='phillallotmentletter1.aspx';</script>");
    }
    protected void submit_Click2(object sender, EventArgs e)
    {
        ...
        Response.Write("<script>window.print(); onafterprint=function(){ window.location.href='phillallotmentletter.aspx';}  </script>");
    }
}