...
public partial class adminallotmentletter : System.Web.UI.Page
{
    SqlConnection con;
    SqlCommand cmd;
    SqlDataAdapter da;
    ...
    protected void submit_Click1(object sender, EventArgs e)
    {
        ...
        Response.Write("<script> window.location.href='adminallotmentletter1.aspx';</script>");
    }
    protected void submit_Click2(object sender, EventArgs e)
    {
        ...
        Response.Write("<script>window.print(); onafterprint=function(){ window.location.href='adminallotmentletter.aspx';}  </script>");
