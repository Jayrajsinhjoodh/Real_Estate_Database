...
public partial class admindemandletter_1 : System.Web.UI.Page
{
    SqlConnection con;
    SqlCommand cmd;
    SqlDataAdapter da;
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        cmd.ExecuteNonQuery();
        Response.Write("<script>alert('Registration Successfully'); window.location.href='admindemandletter.aspx';</script>");
        con.Close();
