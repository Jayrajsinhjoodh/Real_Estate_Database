...
public partial class adminphillblocka : System.Web.UI.Page
{
    SqlConnection con;
    SqlCommand cmd;
    SqlDataAdapter da;
    ...
    {
        mycon();
        cmd = new SqlCommand("select * from customer_registration where sidename='PUSHKAR HILL' and blockno='A'", con);
