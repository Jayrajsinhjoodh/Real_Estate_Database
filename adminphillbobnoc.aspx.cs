...
public partial class adminphillbobnoc : System.Web.UI.Page
{
    SqlConnection con;
    SqlCommand cmd;
    SqlDataAdapter da;
    ...
    {
        Response.Write("<script> window.location.href='adminphillbobnoc-1.aspx';</script>");
    }
    protected void submit_Click2(object sender, EventArgs e)
    {
        ...
        Response.Write("<script>window.print(); onafterprint=function(){ window.location.href='adminphillbobnoc.aspx';}  </script>");
