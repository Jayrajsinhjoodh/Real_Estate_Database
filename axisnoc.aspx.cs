...
public partial class axisnoc : System.Web.UI.Page
{
    ...
    {
        Response.Write("<script> window.location.href='axisnoc-1.aspx';</script>");
    }
    protected void submit_Click2(object sender, EventArgs e)
    {
        ...
        Response.Write("<script>window.print(); onafterprint=function(){ window.location.href='axisnoc.aspx';}  </script>");
