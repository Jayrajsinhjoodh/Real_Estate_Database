<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adminphillblockc.aspx.cs" Inherits="adminphillblockc" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
        <link rel="stylesheet" href="font-awesome/css/font-awesome.css">
<link rel="stylesheet" href="blockc.css">
<head runat="server">
    <title></title>
</head>
<body>
   ...
   <nav>
        ...
        <div class="mainbox">
        <div class="box1">PUSHKAR HILL <br /> Block:-c</div>

        <div style="margin:auto; width:90%; overflow:auto">



            <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="Black" AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellSpacing="2" OnRowCommand="GridView1_RowCommand">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="flatno">
                        <ItemTemplate>
                            <%--<asp:Label ID="Label4" runat="server" Text='<%#Eval("Flatno") %>'></asp:Label>--%>
                           <%-- <asp:HyperLink ID="HyperLink1" Text='<%#Eval("Flatno") %>' NavigateUrl="~/docview.aspx" runat="server"></asp:HyperLink>
                       --%>
                             <a href='dminphilldocview.aspx?flatno=<%#Eval("Flatno") %>'><%#Eval("Flatno") %></a>
                    ...
                    <asp:TemplateField HeaderText="Nema3">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="CostValue">
                        <ItemTemplate>
