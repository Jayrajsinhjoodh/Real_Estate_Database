...
public partial class adminphillblockc : System.Web.UI.Page
{
    SqlConnection con;
    SqlCommand cmd;
    SqlDataAdapter da;
    ...
    {
        mycon();
        cmd = new SqlCommand("select * from customer_registration where sidename='PUSHKAR HILL' and blockno='C'", con);
