...
public partial class adminallotmentletter1 : System.Web.UI.Page
{
    SqlConnection con;
    SqlCommand cmd;
    SqlDataAdapter da;
    ...
    protected void submit_Click1(object sender, EventArgs e)
    {
        ...
        cmd.ExecuteNonQuery();
        Response.Write("<script>alert('Registration Successfully'); window.location.href='adminallotmentletter.aspx';</script>");
        con.Close();
    }
