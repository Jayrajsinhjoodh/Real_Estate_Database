...
public partial class adminbobnoc_1 : System.Web.UI.Page
{
    SqlConnection con;
    SqlCommand cmd;
    SqlDataAdapter da;
    ...
    protected void submit_Click(object sender, EventArgs e)
    {
        ...
        cmd.ExecuteNonQuery();
        Response.Write("<script>alert('Registration Successfully'); window.location.href='adminbobnoc.aspx';</script>");
        con.Close();
