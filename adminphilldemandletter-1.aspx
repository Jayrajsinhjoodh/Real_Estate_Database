<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adminphilldemandletter-1.aspx.cs" Inherits="adminphilldemandletter_1" %>
...
<nav>
        ...
        <div class="menu">
            <ul>
                <%--<li><a href="philldemandletter.aspx"><i class="fa fa-undo"></i> Back</a></li>--%>
    ...
    <div class="box"><img src="IMG-20210814-WA0023.jpg" style="width: 80px;" alt="" srcset="">
        <div class="box1">
            ...
            <div class="b">Project Name  :  <b>PUSHKAR HILL</b></div>
            <div class="c">Account Name  :  <b>SUN INFRA </b>FOR PUSHKAR HILL RERA COLLECTION AC _(A/c name as per Bank records)</div>
