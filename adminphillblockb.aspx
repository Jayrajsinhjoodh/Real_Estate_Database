<%@ Page Language="C#" AutoEventWireup="true" CodeFile="adminphillblockb.aspx.cs" Inherits="adminphillblockb" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
    <link rel="stylesheet" href="font-awesome/css/font-awesome.css">
<link rel="stylesheet" href="blockb.css">
<head runat="server">
    <title></title>
</head>
<body>
    ...
    <nav>
        ...
        <div class="box1">PUSHKAR HILL <br /> Block:-B</div>
            ...
            <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="Black" AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellSpacing="2" OnRowCommand="GridView1_RowCommand">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="flatno">
                        ...
                        --%>
                              <a href='adminphilldocview.aspx?flatno=<%#Eval("Flatno") %>'><%#Eval("Flatno") %></a>
                    ...
                    <asp:TemplateField HeaderText="Naem2">
                         <ItemTemplate>
